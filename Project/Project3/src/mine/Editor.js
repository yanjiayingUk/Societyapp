...
export default class Editor extends Component {
    ...
    componentDidMount() {
        ...
        AsyncStorage.getItem('user')
            .then(res => {
                // console.log("http://"+this.state.ipAndPort+"/login/person");
                res = JSON.parse(res);
                ...
                this.setState({
                    ...
                    fetch("http://"+this.state.ipAndPort+"/login/person",{ 
            ...
            <View>
                ...
                <View style={{ alignItems: 'center', backgroundColor: 'white', height: height * 0.9 }}>
                    ...
                    <View
                        ...
                        <Text style={{ fontSize: 25, marginBottom: 5, marginLeft: 8 }}>{this.state.data.college}</Text>
                    </View>
                    <View
                        style={{
                            width: '80%',
                        ...
                        <Text style={{ fontSize: 25, marginBottom: 5, marginLeft: 8 }}>{this.state.data.snumber}</Text>
                    </View>
                    <View
                        style={{
                            width: '80%',
