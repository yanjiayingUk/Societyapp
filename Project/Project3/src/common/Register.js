...
export default class Register extends Component {
    ...
    render() {
        return (
            <ImageBackground source={require("../../assets/beijing.jpg")} style={{width:"100%",height:"100%"}}>
            <View style={{ flex: 1, justifyContent: 'center' }}>
                <View
                    ...
                    <View
                        ...
                        <Text style={{color:"#0D0D0D",marginLeft:2}}><Icon name="laptop" color="brown"/>&emsp;密&ensp;&ensp;码</Text>
                        <TextInput
