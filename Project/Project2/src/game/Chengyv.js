...
export default class Chengyv extends Component{
render(){
  return (
    <View style={{height:height,width:width}}>
        ...
        <TouchableOpacity
          ...
          >
            ...
            <Text style={styles.gugong}>成语对对碰</Text>
        </View>
      </ImageBackground>
      <ImageBackground source={require("../../assets/dqh/homebc.png")} style={{width: '100%',height:height}}>
        <View style={{width:640*w,height:height*0.7}}>
            <WebView source={{ uri: 'https://dqh123456.github.io/pintu/chengyv.html' }} style={{height:height,width:width}}/>
        </View>
      </ImageBackground>
